...
/*
impl Over<Rgb> for &mut Rgb {
    type Output = ();

    fn over(self, _: Rgb) {}
}

impl Over<Rgba> for &mut Rgb {
    type Output = ();

    fn over(self, _: Rgba) {}
}

impl Over<PreRgba> for &mut Rgb {
    type Output = ();

    fn over(self, _: PreRgba) {}
}

impl Over<&mut Rgb> for Rgb {
    type Output = ();
