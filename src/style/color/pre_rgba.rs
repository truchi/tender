...
impl Over<Rgba> for &mut PreRgba {
    type Output = ();
...
impl Over<PreRgba> for &mut PreRgba {
    type Output = ();
...
impl Over<&mut Rgba> for PreRgba {
    type Output = ();
...
impl Over<&mut PreRgba> for PreRgba {
    type Output = ();
