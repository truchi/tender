...
// impl<'a, T> Grid for &&'a T
// where
// &'a T: Grid,
// {
// type Item = <&'a T as Grid>::Item;
//
// unsafe fn item_unchecked(self, index: impl Index0D) -> Self::Item {
// (*self).item_unchecked(index.unchecked())
// }
// }
//
// impl<'a, T> GridRow for &&'a T
// where
// &'a T: GridRow,
// {
// type Row = <&'a T as GridRow>::Row;
//
// unsafe fn row_unchecked(self, index: impl Index1D) -> Self::Row {
// (*self).row_unchecked(index.row_unchecked(self.size()))
// }
// }
//
// impl<'a, T> GridRows for &&'a T
// where
// &'a T: GridRows,
// {
// type Rows = <&'a T as GridRows>::Rows;
//
// unsafe fn rows_unchecked(self, index: impl Index2D) -> Self::Rows {
// (*self).rows_unchecked(index.unchecked(self.size()))
// }
// }
//
// impl<'a, 'b: 'a, T> Grid for &'b mut &'a mut T
// where
// &'b mut T: Grid,
// {
// type Item = <&'b mut T as Grid>::Item;
//
// unsafe fn item_unchecked(self, index: impl Index0D) -> Self::Item {
// (*self).item_unchecked(index.unchecked())
// }
// }
//
// impl<'a, 'b: 'a, T> GridRow for &'b mut &'a mut T
// where
// &'b mut T: GridRow,
// {
// type Row = <&'b mut T as GridRow>::Row;
//
// unsafe fn row_unchecked(self, index: impl Index1D) -> Self::Row {
// (*self).row_unchecked(index.row_unchecked(self.size()))
// }
// }
//
// impl<'a, 'b: 'a, T> GridRows for &'b mut &'a mut T
// where
// &'b mut T: GridRows,
// {
// type Rows = <&'b mut T as GridRows>::Rows;
//
// unsafe fn rows_unchecked(self, index: impl Index2D) -> Self::Rows {
// (*self).rows_unchecked(index.unchecked(self.size()))
// }
...
//
// unsafe fn item_unchecked(self, index: impl Index0D) -> Self::Item {
// self.grid.item_unchecked(index.unchecked())
// }
// }
//
// impl<'a, T> GridRow for &'a Crop<T>
// where
// &'a T: GridRow,
// {
// type Row = <&'a T as GridRow>::Row;
//
// unsafe fn row_unchecked(self, index: impl Index1D) -> Self::Row {
// self.grid.row_unchecked(index.row_unchecked(self.size()))
// }
// }
//
// impl<'a, T> GridRows for &'a Crop<T>
// where
// &'a T: GridRows,
// {
// type Rows = <&'a T as GridRows>::Rows;
//
// unsafe fn rows_unchecked(self, index: impl Index2D) -> Self::Rows {
// self.grid.rows_unchecked(index.unchecked(self.size()))
// }
// }
//
// impl<'a, T> Grid for &'a mut Crop<T>
// where
// &'a mut T: Grid,
// {
...
// }
//
// impl<'a, T> GridRow for &'a mut Crop<T>
// where
// &'a mut T: GridRow,
// {
// type Row = <&'a mut T as GridRow>::Row;
//
// unsafe fn row_unchecked(self, index: impl Index1D) -> Self::Row {
// self.grid.row_unchecked(index.row_unchecked(self.size()))
// }
// }
//
// impl<'a, T> GridRows for &'a mut Crop<T>
// where
// &'a mut T: GridRows,
// {
// type Rows = <&'a mut T as GridRows>::Rows;
//
// unsafe fn rows_unchecked(self, index: impl Index2D) -> Self::Rows {
// self.grid.rows_unchecked(index.unchecked(self.size()))
// }
...
// }
//
// impl<'a, T> GridRow for &'a mut Crop<&mut T>
// where
// &'a mut T: GridRow,
// {
// type Row = <&'a mut T as GridRow>::Row;
...
// }
//
// impl<'a, T> GridRows for &'a mut Crop<&mut T>
// where
// &'a mut T: GridRows,
// {
// type Rows = <&'a mut T as GridRows>::Rows;
